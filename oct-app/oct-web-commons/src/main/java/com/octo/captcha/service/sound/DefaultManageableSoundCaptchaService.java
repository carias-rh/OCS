...
/**
 * <p>Default service implementation : use a {@link com.octo.captcha.service.captchastore.FastHashMapCaptchaStore} as captcha store, and a {@link com.octo.captcha.engine.sound.speller.SpellerSoundCaptchaEngine}</p> It is initialized
...
public class DefaultManageableSoundCaptchaService extends AbstractManageableSoundCaptchaService implements SoundCaptchaService {
    ...
    /**
     * Construct a new SoundCaptchaService with a {@link com.octo.captcha.service.captchastore.FastHashMapCaptchaStore} and a {@link com.octo.captcha.engine.sound.speller.SpellerSoundCaptchaEngine}
     *
