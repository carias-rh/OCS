...
public abstract class ImageCaptchaEngine
     ...
     *
     * @return a com.octo.captcha.CaptchaFactory
     */
    ...
    /**
     * This method use an object parameter to build a com.octo.captcha.CaptchaFactory.
     *
     * @return a com.octo.captcha.CaptchaFactory
     */
    public final ImageCaptcha getNextImageCaptcha() {
        System.out.println("***** getNextImageCaptcha");
     ...
     * @return a new com.octo.captcha.Captcha
     */
