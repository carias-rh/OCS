...
public abstract class AbstractCaptchaService implements CaptchaService {
	...
	protected Logger logger = LogManager.getLogger(AbstractCaptchaService.class);
     ...
     * @throws com.octo.captcha.service.CaptchaServiceException if the ticket is invalid
     */
